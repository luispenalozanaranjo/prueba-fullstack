import { defineComponent, shallowRef, h, resolveComponent, hasInjectionContext, getCurrentInstance, computed, inject, ref, reactive, effectScope, isRef, isReactive, toRaw, getCurrentScope, onScopeDispose, watch, nextTick, toRefs, markRaw, createElementBlock, provide, cloneVNode, Suspense, Fragment, createApp, shallowReactive, toRef, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, isReadonly, isShallow, defineAsyncComponent, mergeProps, withCtx, createTextVNode, useSSRContext } from 'vue';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-6KD8W4X3.mjs')
  },
  {
    name: "libro-id",
    path: "/libro/:id()",
    component: () => import('./_id_-BUJxs2eD.mjs')
  },
  {
    name: "mi-biblioteca",
    path: "/mi-biblioteca",
    component: () => import('./mi-biblioteca-v_spenJC.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-6E4fs2qa.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CTKRL40F.mjs'));
...
export { _export_sfc as _, __nuxt_component_0$1 as a, useNuxtApp as b, asyncDataDefaults as c, defineStore as d, entry$1 as default, createError as e, tryUseNuxtApp as t, useRuntimeConfig as u };
