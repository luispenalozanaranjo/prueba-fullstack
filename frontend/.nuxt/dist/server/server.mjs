import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, ref, markRaw, nextTick, onScopeDispose, watch, toRefs, computed, defineComponent, createElementBlock, provide, cloneVNode, h, resolveComponent, mergeProps, withCtx, createTextVNode, useSSRContext, Suspense, Fragment, defineAsyncComponent, unref, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, createApp } from "vue";
import { $fetch } from "ofetch";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "C:/Users/luisu/Desktop/19-08-2025AFC/prueba-fullstack/frontend/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "C:/Users/luisu/Desktop/19-08-2025AFC/prueba-fullstack/frontend/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "C:/Users/luisu/Desktop/19-08-2025AFC/prueba-fullstack/frontend/node_modules/h3/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter as createRouter$1, RouterView } from "vue-router";
import { toRouteMatcher, createRouter } from "C:/Users/luisu/Desktop/19-08-2025AFC/prueba-fullstack/frontend/node_modules/radix3/dist/index.mjs";
import { defu } from "C:/Users/luisu/Desktop/19-08-2025AFC/prueba-fullstack/frontend/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, withQuery, isScriptProtocol, parseQuery, withTrailingSlash, withoutTrailingSlash } from "C:/Users/luisu/Desktop/19-08-2025AFC/prueba-fullstack/frontend/node_modules/ufo/dist/index.mjs";
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-6KD8W4X3.js")
  },
  {
    name: "libro-id",
    path: "/libro/:id()",
    component: () => import("./_nuxt/_id_-BUJxs2eD.js")
  },
  {
    name: "mi-biblioteca",
    path: "/mi-biblioteca",
    component: () => import("./_nuxt/mi-biblioteca-v_spenJC.js")
  }
];
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`Mi Biblioteca`);
      } else {
        return [
          createTextVNode("Mi Biblioteca")
        ];
      }
    }),
    _: 1
...
_sfc_main$3.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/UiHeader.vue");
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-6E4fs2qa.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-CTKRL40F.js"));
